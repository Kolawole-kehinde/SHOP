    ...
    <div className="py-8">
      <div className="container">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {/* FIRST COLUMN - slide in from left */}
          <AnimatedWrapper animation="animate__slideInLeft" className="col-span-1 lg:col-span-2">
            <div className="bg-gradient-to-br from-gray-300/90 to-gray-100 py-10 pl-5 text-white rounded-3xl relative h-[400px] flex items-end">
              <div>
                <div className="mb-4">
          ...
          {/* THIRD COLUMN - zoom in */}
          <AnimatedWrapper animation="animate__zoomIn" className="col-span-1 sm:col-span-2 lg:col-span-1">
            <div className="bg-gradient-to-br from-brandBlue/90 to-brandBlue/90 py-10 pl-5 text-white rounded-3xl relative h-[400px] flex items-end">
              <div>
                <div className="mb-4">
                  <p className="mb-1 text-white">Enjoy</p>
                  <p className="text-2xl font-semibold mb-2">With</p>
