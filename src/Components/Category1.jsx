          ...
          <div className="bg-gradient-to-br from-black/90 to-black/70 py-10 px-5 text-white rounded-3xl relative h-[400px] flex items-end">
            <div className="flex flex-col justify-between w-full">
              ...
              <div className="mb-8">
                ...
                <p className="text-4xl sm:text-5xl xl:text-6xl font-bold opacity-20 mb-2">
                  Earphone
                </p>
                <Link to="/shop">
              ...
              <img
                ...
                alt="earphone"
                className="w-[250px] sm:w-[320px] absolute bottom-0 sm:-translate-y-0 pointer-events-none"
              />
            </div>
          </div>
