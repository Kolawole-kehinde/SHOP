    ...
    <section id='footer'>
      <div className='container my-10 mt-40 flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 text-base font-[Outfit]'>
        ...
        <div>
          ...
          <p className='w-full md:w-2/3 text-gray-600 pt-5 text-2xl'>
        ...
        {/* Second column */}
        <div>
          <p className='text-2xl  mb-5 uppercase font-bold text-gray-600'>Company</p>
          <ul className='flex flex-col gap-2 text-gray-600 text-2xl'>
            <li>Home</li>
            <li>About Us</li>
            <li>Delivery</li>
            <li>Privacy</li>
        ...
        <div className='col-span-full'>
          ...
          <p className='py-5 text-center text-2xl text-gray-600'>Copyright 2024@ Khennycool.dev - All Right Reserved.</p>
        </div>
